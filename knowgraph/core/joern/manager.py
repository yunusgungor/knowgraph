...
def download_joern(version: str = JOERN_VERSION) -> Path:
    ...
    if zip_path.exists():
        ...
        try:
            ...
            print(f"✅ Using existing Joern download...")
            return zip_path
        except zipfile.BadZipFile:
            logger.warning(f"⚠️  Existing zip file is corrupted, will re-download")
            print(f"⚠️  Existing download is corrupted, re-downloading...")
