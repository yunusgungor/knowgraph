...
async def handle_analyze_call_graph(arguments: dict[str, Any], PROJECT_ROOT: Path) -> list[types.TextContent]:
    ...
    try:
        ...
        if analysis_type == "validate":
            ...
            output = f"📊 Call Graph Validation\n"
            output += f"━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n"
            ...
            output = f"🔄 Recursive Call Detection\n"
            output += f"━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n"
...
async def handle_generate_cpg(arguments: dict[str, Any], PROJECT_ROOT: Path) -> list[types.TextContent]:
    ...
    try:
        ...
        # Generate CPG
        output = f"📦 Generating Code Property Graph\n"
        output += f"━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n"
        ...
        try:
            ...
            output += f"✅ **CPG Generated Successfully!**\n\n"
            output += f"**CPG Path**: `{cpg_path}`\n\n"
            output += f"💡 **Next Steps**:\n"
            output += f"- Use `knowgraph_joern_query` to query the CPG\n"
            output += f"- Use `knowgraph_security_scan` to find vulnerabilities\n"
            output += f"- Use `knowgraph_find_dead_code` to detect unused code\n"
            output += f"- Use `knowgraph_analyze_call_graph` to analyze call relationships\n"
            output += f"- Use `knowgraph_export_cpg` to export in various formats\n"
            ...
            error_output += f"💡 **Troubleshooting**:\n"
            error_output += f"- Ensure Joern is installed: `knowgraph-setup-joern`\n"
            error_output += f"- Check if source path contains supported code files\n"
            error_output += f"- Try increasing timeout if source is large\n"
